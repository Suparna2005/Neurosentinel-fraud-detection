...
report_content = """# NEUROSENTINEL: ADVANCED CREDIT CARD FRAUD DETECTION USING MACHINE LEARNING
...
**[INSERT SCREENSHOT OF DASHBOARD HOMEPAGE HERE]**
...
**[INSERT SCREENSHOT OF A LEGITIMATE TRANSACTION SCAN HERE]**

*Figure 6.2: A successful scan of a legitimate transaction, showing 0% fraud probability.*
...
**[INSERT SCREENSHOT OF A FRAUDULENT TRANSACTION SCAN HERE]**
...
**[INSERT SCREENSHOT OF TRENDING/ANALYTICS PAGE HERE]**
...
with open(r"c:\Users\supar\OneDrive\Documents\project\fraud detection\Final_Project_Report.md", "w", encoding="utf-8") as f:
    f.write(report_content)
    
print("Successfully generated Final_Project_Report.md")
